...
class EthereumService:
    ...
    def get_wallet_info(self, wallet_address: str) -> WalletInfoResponse:
        ...
        native_token = NativeToken(symbol="ETH", decimals=18, balance=native_balance)
    ...
    def _get_token_info(self, contract_address: str) -> Optional[Dict[str, Any]]:
        """Get token information from contract using Etherscan's contract API"""
